...
var _specialWordPerLetters = require("./specialWordPerLetters.process");
...
function WrappLetter(_ref) {
  ...
  let { wordToWrapp } = SpecialWrapp; // comprobation if searchWordValue or wordToWrapp is an array
  ...
  var arrElements = crumbledText
    .map(function (wrappElement, index) {
      ...
      const arrComprobations = [
        !PerWord, // if the array is empty, return the false
      ...
      return (0, _specialWordPerLetters.__specialWorld_PerLetters__)({
        index,
