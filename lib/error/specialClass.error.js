...
exports.error__Filter_SpecialClass__ = error__Filter_SpecialClass__;

var _whatIsIt = require("../common/whatIsIt");

function error__Filter_SpecialClass__(SelectClass, PerWord) {
  // first the code need know if SelectClass is an Object
  if ((0, _whatIsIt.whatItIs)(SelectClass) != "[object Object]") throw new Error("SelectClass must be an Object!!! :s");
  const SelectClassKeys = Object.keys(SelectClass); // If SelectClass an empty Object the filter ends here
