...
function WrappingLetters(_ref) {
  ...
  var _wordOptions$ = wordOptions[0],
      _wordOptions$$PerWord = _wordOptions$.PerWord,
      PerWord = _wordOptions$$PerWord === void 0 ? false : _wordOptions$$PerWord,
      _wordOptions$$ClassTo = _wordOptions$.ClassToAdd,
      ClassToAdd = _wordOptions$$ClassTo === void 0 ? new String() : _wordOptions$$ClassTo,
      _wordOptions$$SelectC = _wordOptions$.SelectClass,
      SelectClass = _wordOptions$$SelectC === void 0 ? {} : _wordOptions$$SelectC;
  ...
  var text = PerWord ? word.split(" ") : (0, _toConsumableArray2["default"])(word);
