...
function WrappLetter(_ref) {
  var _ref$SelectClass = _ref.SelectClass,
    ...
    spaceBetweenWord: spaceBetweenWord
  } : _ref$SelectClass,
      text = _ref.text,
  ...
  return function () {
    var _SelectClass$searchWo = SelectClass.searchWordValue,
        searchWordValue = _SelectClass$searchWo === void 0 ? [] : _SelectClass$searchWo,
        _SelectClass$searchWo2 = SelectClass.searchWordValueLength,
        searchWordValueLength = _SelectClass$searchWo2 === void 0 ? 0 : _SelectClass$searchWo2,
        _SelectClass$specialC = SelectClass.specialClass,
        specialClass = _SelectClass$specialC === void 0 ? new String() : _SelectClass$specialC,
        _SelectClass$spaceBet = SelectClass.spaceBetweenWord,
        spaceBetweenWord = _SelectClass$spaceBet === void 0 ? false : _SelectClass$spaceBet;
