...
describe("Mount WrappingLetters", () => {
  ...
  test("Mount component with options { SelectClass: { wordToSearch: 'the', classToAdd: 'my-class', spaceBetweenWord: false } }, and word is 'Carlos is a good person, buthe is not a good person'", () => {
    render(<WrappingLetters word="Carlos is a good person, buthe is not a good person" wordOptions={[{ SelectClass: { wordToSearch: 'the', classToAdd: 'my-class', spaceBetweenWord: false } }]}/>, {
      container
    });
    expect(container).toMatchInlineSnapshot(`
    <div>
